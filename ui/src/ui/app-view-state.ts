...
export type AppViewState = {
  ...
  issuesStatusFilter: string | null;
  issuesSeverityFilter: string | null;
  issuesAddFormVisible: boolean;
  issuesMoreProjectsOpen: boolean;
  issuesMoreProjectsSearch: string;
  issuesBatchPlanDismissed: boolean;
  issuesBatchPlan: Array<{ taskId: string; title: string; severity: string }>;
  issuesProjectFilter: string | null;
  // Backward-compatible aliases
  backlogLoading: boolean;
  backlogTasks: AppViewState["issuesList"];
  backlogError: string | null;
  backlogStatusFilter: string | null;
  backlogSeverityFilter: string | null;
  backlogAddFormVisible: boolean;
  backlogMoreProjectsOpen: boolean;
  backlogMoreProjectsSearch: string;
  backlogBatchPlanDismissed: boolean;
  backlogBatchPlan: Array<{ taskId: string; title: string; severity: string }>;
  backlogProjectFilter: string | null;
